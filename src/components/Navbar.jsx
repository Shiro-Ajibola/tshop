    ...
    <div className='bg-white dark:bg-gray-900 dark:text-white duration-200 relative z-40'>
        <div className='py-4'>
            <div className='container flex justify-between items-center'>
                ...
                <div className='flex justify-flex justify-between items-center gap-4'>
                  ...
                  <FaCartShopping className='text-x1 text-gray-600 dark:text-gray-400'/>
